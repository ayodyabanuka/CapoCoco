...
const ProductPortfolio = () => {
       ...
       return (
              <div>
                     ...
                     <div >
                            <ScrollAnimationWrapper className="hidden xl:grid grid-cols-2 container gap-7 my-10 h-full text-white justify-between items-center px-0 ">
                                   <motion.div animate={{ opacity: [0, 100], x: [-180, 0] }} transition={{ ease: "easeOut", duration: 1 }} className="grid col-span-1 grid-cols-3 bg-yellow-700 bg-cover items-center place-items-end p-16 bg-center h-[800px] rounded-3xl bg-[url('/kingback.png')]">
                                   ...
                                   <motion.div animate={{ opacity: [0, 100], x: [180, 0] }} transition={{ ease: "easeOut", duration: 1 }} className="grid col-span-1 grid-cols-3 h-[800px] rounded-3xl items-center place-items-center p-16 bg-center bg-green-700 bg-cover bg-[url('/tenderback.png')]">
                     ...
                     <div className="xl:hidden hidden md:grid grid-cols-1 mx-4 max-w-[1920px] text-center gap-7 my-10 h-full bg-bottom bg-no-repeat bg-cover overflow-hidden text-white justify-between items-center px-0 lg:px-10">
                            <motion.div initial={{ opacity: 0, y: 180 }} whileInView={{ opacity: 1, y: 0 }} transition={{ ease: "easeOut", duration: 1 }} className="grid col-span-1 bg-yellow-700 bg-cover content-center place-items-center overflow-hidden items-center h-[800px] rounded-3xl bg-[url('/kingbackmobile.png')]">
                            ...
                            <motion.div initial={{ opacity: 0, y: 180 }} whileInView={{ opacity: 1, y: 0 }} transition={{ ease: "easeOut", duration: 1 }} className="grid col-span-1  h-[790px] rounded-3xl content-center place-items-center items-center bg-bottom bg-no-repeat overflow-hidden bg-green-700 bg-cover bg-[url('/tenderbackmobile.png')]">
